...
from box import Box
from uflow.uflow_augmentation import geometric_augmentation, photometric_augmentation
...
def uflow_augmentation(images, flow=None, mask=None,
                       crop_height=640, crop_width=640,
                       geo_aug_params=None, photo_aug_params=None):
    ...
    if geo_aug_params is None:
        geo_aug_params = {}
    if photo_aug_params is None:
        photo_aug_params = {}

    # apply geometric augmentation functions
    images, flow, mask = geometric_augmentation(
      images, flow, mask, crop_height, crop_width, **geo_aug_params)
    # apply photometric augmentation functions
    images_aug = photometric_augmentation(images, **photo_aug_params)
